package org.firstinspires.ftc.teamcode.MalekHSV;
...
public class blobDetectionTest extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        if (max_distance == distance1){
            ...
            telemetry.addData("pos deteceted: ", tp_zone+" = left zone");
            telemetry.update();
            ...
            telemetry.addData("pos deteceted: ", tp_zone+" = Mid zone");
            telemetry.update();

            tp_zone = 2;
        } else {
            telemetry.addLine("right");
            telemetry.addData("pos deteceted: ", tp_zone+" = right zone");
            telemetry.update();
            tp_zone = 3;
        }
